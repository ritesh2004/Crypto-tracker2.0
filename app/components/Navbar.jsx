            ...
            <nav class="bg-white h-[4.375rem] border-gray-200 shadow-lg">
                <div class="max-w-screen-xl flex flex-wrap flex-row-reverse items-center justify-between mx-auto p-4">
                    <div class="flex md:order-2">
                        ...
                        {!open&&<button type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" class="md:hidden text-gray-500 hover:bg-gray-100 rounded-lg text-sm p-2.5 mr-1" onClick={()=>setOpen(true)}>
                        ...
                        <div class="relative hidden md:block">
                            ...
                            <input type="text" id="search-navbar" class="block w-[15rem] h-[1.875rem] p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" value={search} onChange={(e)=>setSearch(e.target.value)} placeholder="Type any cryptocurrency..."/>
                        </div>
                        <button data-collapse-toggle="navbar-search" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100" aria-controls="navbar-search" aria-expanded="false">
